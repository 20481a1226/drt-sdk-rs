...
fn v_0_39_replace_in_files(sc_crate_path: &Path) {
    ...
    replace_in_files(
        ...
        &[
            ...
            Query::substring(
                "elrond_wasm_debug::denali_go",
                "dharitri_sc_scenario::run_go",
            ),
            Query::substring(
                "elrond_wasm_debug::denali_rs",
                "dharitri_sc_scenario::run_rs",
            ),
            Query::substring("elrond_wasm_debug", "dharitri_sc_scenario"),
            Query::substring("elrond_wasm_modules", "dharitri_sc_modules"),
            Query::substring("elrond_wasm_node", "dharitri_sc_wasm_adapter"),
            Query::substring("elrond_wasm", "dharitri_sc"),
